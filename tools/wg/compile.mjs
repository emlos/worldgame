...
const OUTPUT_FILE = path.join(PROJECT_ROOT, "src/generated/wg/scenes.js"); //TODO: minify the js file to reduce the size of the generated scenes.js file, since it can get quite large with many scenes
