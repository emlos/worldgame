...
brain.restoreJSON({
    ...
    currentAction: {
        ...
        startedAt: "2026-08-24T10:43:00.000Z",
        arrivalAt: "2026-08-24T10:53:00.000Z",
        fromLocationId: "home",
        targetLocationId: "errand",
        targetPlaceId: "errand-place",
        route: {
    ...
    nextDecisionAt: "2026-08-24T10:53:00.000Z",
    lastUpdatedAt: "2026-08-24T10:52:00.000Z",
});

brain.updateTo(new Date("2026-08-24T10:53:00.000Z"), game);

check("higher-priority obligation replaces the completed lower-priority goal", brain.currentGoal?.ruleId === obligationRule.id);
check("NPC departs for the obligation at its required departure time", brain.currentAction?.startedAt === "2026-08-24T10:53:00.000Z");
