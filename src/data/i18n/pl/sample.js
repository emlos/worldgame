export const CHOICES = {
    ...
    "choice.home.waitForPackage": "Sprawdź status dostawy (demo)",
    "choice.home.stopWaitingForPackage": "Przestań myśleć o paczce (demo)",
...
export const SCENES = {
    ...
    "scene.home.default.morning": "Poranne słońce wpada przez zasłony.",
    "scene.home.default.evening": "Wieczór zapada. Na zewnątrz słychać cichy szum miasta.",
    "scene.home.default.taylorPresent": "Taylor cierpliwie na ciebie czeka.",
    "scene.home.default.waitingForPackage": "Myślami wracasz do przesyłki, na którą czekasz.",
    ...
    "scene.street.default.text":
        "Jesteś na zewnątrz na ulicy {street.name}. Wokół czuć zgiełk miasta.",
