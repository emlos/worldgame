...
import { getPlaceInstanceTarget, PLACE_DISTRIBUTION_KIND } from "../data/place.js";
import { STREET_REGISTRY } from "../data/street.js";
import { analyzeGraph, collectDegreeTwoCorridors, undirectedEdgeKey } from "./worldMapGraph.js";

//TODO: explain the tweakable values in docs
...
class WorldMapGenerator {
    constructor({ rnd, mapWidth, mapHeight, placeRegistry }) {
        this.rnd = rnd;
...
export function generateWorldMap({ rnd, mapWidth, mapHeight, placeRegistry }) {
    const generated = new WorldMapGenerator({ rnd, mapWidth, mapHeight, placeRegistry });
    return { locations: generated.locations, edges: generated.edges };
}
