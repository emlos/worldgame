...
import { validateWGSystemState } from "../../story/wg/runtime/storySystemRegistry.js";
import {
    GOAL_TYPE,
    NPC_ACTION_TYPE,
    TARGET_TYPE,
    OBLIGATION_EARLY_ARRIVAL_MINUTES,
} from "../../characters/npc/behavior.js";
import { RANDOM_HOLIDAYS, MONTH_DAYS, DayKind } from "../../world/data/calendar.js";
import { DAY_KEYS, MS_PER_MINUTE } from "../../world/data/time.js";
import { WeatherType } from "../../world/data/weather.js";
import { PLAYER_TEMPERATURE_VALUES, SKILLS, STATS } from "../../characters/player/stats.js";
import {
    RELATIONSHIP_MAX,
    RELATIONSHIP_MIN,
} from "../../characters/core/relationship.js";
import {
    SCHOOL_SUBJECTS,
...
import {
    ...
    PLACE_REGISTRY,
} from "../../world/data/place.js";
import {
    PLACE_ENTER_MINUTES,
    PLACE_LEAVE_MINUTES,
} from "../../world/data/travel.js";
import { Weather } from "../../world/model/weather.js";
...
function validatePlayer(data, path, npcProfiles, gameTime) {
    ...
    for (const id of Object.keys(SCHOOL_SUBJECTS)) {
        ...
        integer(required(subject, "achievement", subjectPath), `${subjectPath}.achievement`, {
            min: SUBJECT_ACHIEVEMENT_MIN,
